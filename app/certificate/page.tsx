...
import { Download, ArrowLeft, Award, Heart, Sparkles, Leaf, Instagram } from "lucide-react"
...
export default function CertificatePage() {
  ...
  return (
    <div className="container max-w-4xl px-4 py-8">
      ...
      {/* Certificate Preview */}
      <Card className="mb-6 overflow-hidden border-0 bg-gradient-to-br from-yellow-50 via-green-50 to-emerald-50">
